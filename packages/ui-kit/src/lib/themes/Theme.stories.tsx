                ...
                <div style={{ display: 'grid', gap: '20px', maxWidth: '600px' }}>
                    <Card>
                        <CardContent>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '10px' }}>
                                <div style={{ padding: '10px', background: theme.colors.surface, borderRadius: theme.radius.md, border: `1px solid ${theme.colors.border}` }}>
                                    <strong style={{ color: theme.colors.text }}>Surface</strong>
                                    <div style={{ color: theme.colors.text, fontSize: '12px' }}>{theme.colors.surface}</div>
                                </div>
                                <div style={{ padding: '10px', background: theme.colors.primary, borderRadius: theme.radius.md }}>
                                    <strong style={{ color: 'white' }}>Primary</strong>
                                    <div style={{ color: 'white', fontSize: '12px' }}>{theme.colors.primary}</div>
                                </div>
                                <div style={{ padding: '10px', background: theme.colors.border, borderRadius: theme.radius.md }}>
                                    <strong style={{ color: theme.colors.text }}>Border</strong>
                                    <div style={{ color: theme.colors.text, fontSize: '12px' }}>{theme.colors.border}</div>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardContent>
                            ...
                            <div style={{ display: 'grid', gap: '15px' }}>
                                <div>
                                    <label style={{ color: theme.colors.text, display: 'block', marginBottom: '5px' }}>Input Field</label>
                    ...
                    <Card>
                        <CardContent>
                            ...
                            <div style={{ display: 'grid', gap: '10px' }}>
                                <div style={{ padding: theme.spacing(1), background: theme.colors.surface, borderRadius: theme.radius.md, border: `1px solid ${theme.colors.border}` }}>
                                    <span style={{ color: theme.colors.text }}>spacing(1) = {theme.spacing(1)}</span>
                                </div>
                                <div style={{ padding: theme.spacing(2), background: theme.colors.surface, borderRadius: theme.radius.md, border: `1px solid ${theme.colors.border}` }}>
                                    <span style={{ color: theme.colors.text }}>spacing(2) = {theme.spacing(2)}</span>
                                </div>
                                <div style={{ padding: theme.spacing(3), background: theme.colors.surface, borderRadius: theme.radius.md, border: `1px solid ${theme.colors.border}` }}>
                                    <span style={{ color: theme.colors.text }}>spacing(3) = {theme.spacing(3)}</span>
                                </div>
                                <div style={{ padding: theme.spacing(4), background: theme.colors.surface, borderRadius: theme.radius.md, border: `1px solid ${theme.colors.border}` }}>
                    ...
                    <Card>
                        <CardContent>
                            ...
                            <div style={{ display: 'grid', gap: '10px' }}>
                                <div style={{ padding: '20px', background: theme.colors.surface, borderRadius: theme.radius.md, border: `1px solid ${theme.colors.border}` }}>
                                    <span style={{ color: theme.colors.text }}>Medium Radius: {theme.radius.md}</span>
                                </div>
                                <div style={{ padding: '20px', background: theme.colors.surface, borderRadius: theme.radius.lg, border: `1px solid ${theme.colors.border}` }}>
