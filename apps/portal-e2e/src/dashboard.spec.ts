...
test.describe('Portal Dashboard', () => {
    ...
    test('should display function descriptions', async () => {
        ...
        await expect(helpers.page.locator('ul li').first()).toContainText('Forms - View and manage forms');
        await expect(helpers.page.locator('ul li').nth(1)).toContainText('Posts - View and manage posts');
        await expect(helpers.page.locator('ul li').nth(2)).toContainText('Admin - Access admin functions');
    });
