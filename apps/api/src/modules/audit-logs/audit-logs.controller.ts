...
export class AuditLogsController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves audit logs for the current organization with optional filtering. Supports pagination, date range filtering, and filtering by resource type and action. Results are ordered by timestamp descending.',
  })
  @ApiQuery({
    name: 'resource',
    required: false,
