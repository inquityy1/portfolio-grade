...
export class FieldsController {
    ...
    @ApiOperation({
        ...
        description: 'Creates a new field within a specific form. Fields define the input elements that users will interact with when filling out the form.'
    })
    @ApiParam({
        name: 'id',
    ...
    @ApiOperation({
        ...
        description: 'Updates the configuration of an existing field. All fields are optional and only provided fields will be updated.'
    })
    @ApiParam({
        name: 'fieldId',
    ...
    @ApiResponse({
        ...
        schema: {
            ...
            properties: {
                ...
                config: { type: 'object', example: { required: true, placeholder: 'Enter your full name', maxLength: 100 } }
            }
        }
    })
    @ApiResponse({ status: 401, description: 'Unauthorized - Invalid or missing JWT token' })
    ...
    @ApiOperation({
        ...
        description: 'Permanently deletes a field from a form. This action cannot be undone and will remove the field from all form submissions.'
    })
    @ApiParam({
        name: 'fieldId',
