...
describe('FieldsController', () => {
  ...
  describe('create', () => {
    ...
    it('should handle service errors', async () => {
      ...
      await expect(controller.create(orgId, mockReq, formId, createFieldDto)).rejects.toThrow(
        NotFoundException,
      );
      expect(fieldsService.create).toHaveBeenCalledWith(orgId, userId, formId, createFieldDto);
    });
  ...
  describe('update', () => {
    ...
    it('should handle service errors', async () => {
      ...
      await expect(controller.update(orgId, mockReq, fieldId, updateFieldDto)).rejects.toThrow(
        NotFoundException,
      );
      expect(fieldsService.update).toHaveBeenCalledWith(orgId, userId, fieldId, updateFieldDto);
    });
