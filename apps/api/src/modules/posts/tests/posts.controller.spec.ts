        ...
        postTags: [
          {
            postId: postId,
            tagId: 'tag-1',
            tag: { id: 'tag-1', name: 'Tag 1', organizationId: orgId },
          },
        ],
        revisions: [
          { id: 'rev-1', version: 1, content: 'Post Content', createdAt: new Date(), postId },
        ],
      };
  ...
  describe('update', () => {
    it('should update a post', async () => {
      ...
      const expectedPost = {
        ...
        revisions: [
          { id: 'rev-2', version: 2, content: 'Updated content', createdAt: new Date(), postId },
        ],
      };
  ...
  describe('rollback', () => {
    it('should rollback to a specific revision', async () => {
      ...
      const expectedPost = {
        ...
        postTags: [],
        revisions: [
          { id: 'rev-4', version: 4, content: 'Rollback content', createdAt: new Date(), postId },
        ],
      };
