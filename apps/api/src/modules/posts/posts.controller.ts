...
export class PostsController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves posts for the current organization with optional filtering by search query, tag, and pagination. Supports cursor-based pagination and includes file assets if requested.',
  })
  @ApiQuery({
    name: 'limit',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves detailed information about a specific post including its content, tags, file assets, and metadata.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new post with the specified title, content, and optional tags. Automatically updates tag usage counts and generates preview images.',
  })
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description:
      'Updates an existing post with optimistic locking. Requires the current version number to prevent conflicts. Automatically updates tag usage counts when tags are changed.',
  })
  @ApiParam({
    name: 'id',
    ...
    schema: {
      ...
      properties: {
        message: {
          type: 'array',
          items: { type: 'string' },
          example: ['version must be a number', 'title must be at least 2 characters long'],
        },
        error: { type: 'string', example: 'Bad Request' },
        statusCode: { type: 'number', example: 400 },
      },
  ...
  @ApiOperation({
    ...
    description:
      'Permanently deletes a post and all its associated data. Automatically decrements tag usage counts for all associated tags.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all revision history for a specific post, showing version numbers and timestamps.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Rolls back a post to a specific version from its revision history. Creates a new version with the content from the specified revision.',
  })
  @ApiParam({
    name: 'id',
