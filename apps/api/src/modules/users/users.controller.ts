...
export class UsersController {
    ...
    @ApiOperation({
        ...
        description: 'Retrieves all users who are members of the current organization, ordered by creation date ascending.'
    })
    @ApiResponse({
        status: 200,
    ...
    @ApiOperation({
        ...
        description: 'Creates a new user account and automatically assigns them to the specified organization with the given role. The user can be assigned to any organization, not just the current one.'
    })
    @ApiBody({
        ...
        schema: {
            ...
            properties: {
                ...
                organizationId: {
                    type: 'string',
                    example: 'org-a',
                    description: 'Optional organization ID to assign the user to (defaults to current organization)'
                }
            },
    ...
    @ApiResponse({
        ...
        schema: {
            type: 'object',
            properties: {
                message: { type: 'array', items: { type: 'string' }, example: ['email must be a valid email', 'password must be at least 6 characters', 'role must be one of: OrgAdmin, Editor, Viewer'] },
    ...
    @ApiOperation({
        ...
        description: 'Retrieves detailed information about a specific user who is a member of the current organization.'
    })
    @ApiParam({
        name: 'id',
    ...
    @ApiOperation({
        ...
        description: 'Updates user information including name, email, and password. All fields are optional and only provided fields will be updated. Password is automatically hashed.'
    })
    @ApiParam({
        name: 'id',
    ...
    @ApiOperation({
        ...
        description: 'Permanently deletes a user account and all associated data. This action cannot be undone and will remove the user from all organizations and delete all their posts, comments, and other data.'
    })
    @ApiParam({
        name: 'id',
