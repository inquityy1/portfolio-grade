...
export class FormsController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all forms belonging to the current organization, ordered by last updated date descending.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific form with its associated fields. Includes field ordering and complete form schema.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new form with the specified name and schema configuration. The schema defines the form structure and behavior.',
  })
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description:
      'Updates the name and/or schema of an existing form. All fields are optional and only provided fields will be updated.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Permanently deletes a form and all its associated fields and submissions. This action cannot be undone.',
  })
  @ApiParam({
    name: 'id',
