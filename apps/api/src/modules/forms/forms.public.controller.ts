...
export class FormsPublicController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves public form information including form schema and fields. This endpoint is accessible without authentication and is designed for public form rendering. Rate limited to prevent abuse.',
  })
  @ApiParam({
    name: 'id',
