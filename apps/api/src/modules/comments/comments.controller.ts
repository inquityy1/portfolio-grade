...
export class CommentsController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all non-deleted comments for a specific post, ordered by creation date ascending.',
  })
  @ApiParam({
    name: 'postId',
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new comment on a specific post. The comment will be associated with the authenticated user.',
  })
  @ApiParam({
    name: 'postId',
  ...
  @ApiOperation({
    ...
    description:
      'Updates the content of an existing comment. Only the comment author can update their own comments.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden - User does not have Viewer or higher role, or not the comment author',
  })
  ...
  @ApiOperation({
    ...
    description:
      "Soft deletes a comment (marks as deleted but doesn't remove from database). Only the comment author can delete their own comments.",
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Restores a previously soft-deleted comment. Only users with Editor or higher role can restore comments.',
  })
  @ApiParam({
    name: 'id',
