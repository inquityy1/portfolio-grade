...
describe('CreateCommentDto', () => {
  ...
  it('should pass validation with long content', async () => {
    const dto = new CreateCommentDto();
    dto.content =
      'This is a very long comment that contains multiple sentences and should pass validation without any issues. It includes various characters and punctuation marks!';
...
describe('UpdateCommentDto', () => {
  ...
  it('should pass validation with long content', async () => {
    const dto = new UpdateCommentDto();
    dto.content =
      'This is a very long updated comment that contains multiple sentences and should pass validation without any issues. It includes various characters and punctuation marks!';
