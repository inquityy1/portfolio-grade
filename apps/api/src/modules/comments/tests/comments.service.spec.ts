...
describe('CommentsService', () => {
    ...
    describe('create', () => {
        ...
        it('should throw NotFoundException when post is not found', async () => {
            ...
            await expect(service.create(orgId, postId, userId, content)).rejects.toThrow(NotFoundException);
        });
    });
    ...
    describe('update', () => {
        ...
        it('should throw NotFoundException when comment is not found', async () => {
            ...
            await expect(service.update(orgId, commentId, userId, content)).rejects.toThrow(NotFoundException);
        });
        ...
        it('should throw ForbiddenException when trying to edit deleted comment', async () => {
            ...
            await expect(service.update(orgId, commentId, userId, content)).rejects.toThrow(ForbiddenException);
        });
