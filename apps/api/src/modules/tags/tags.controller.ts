...
export class TagsController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves all tags belonging to the current organization, ordered by name alphabetically.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new tag with the specified name. Tag names must be unique within the organization. Automatically creates audit logs and publishes events.',
  })
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description:
      'Updates the name of an existing tag. The new name must be unique within the organization. Automatically creates audit logs and publishes events.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Permanently deletes a tag and all its associations. This action cannot be undone and will remove the tag from all posts. Automatically creates audit logs and publishes events.',
  })
  @ApiParam({
    name: 'id',
