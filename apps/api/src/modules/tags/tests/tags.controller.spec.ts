...
describe('TagsController', () => {
    ...
    describe('update', () => {
        ...
        it('should trim tag name before updating', async () => {
            ...
            expect(mockTagsService.update).toHaveBeenCalledWith(orgId, userId, tagId, { name: trimmedName });
            expect(result).toEqual(expectedTag);
        });
        ...
        it('should handle undefined name in update', async () => {
            ...
            expect(mockTagsService.update).toHaveBeenCalledWith(orgId, userId, tagId, { name: undefined });
            expect(result).toEqual(expectedTag);
        });
    });
