...
describe('OrganizationsService', () => {
    ...
    describe('findAll', () => {
        it('should return all organizations', async () => {
            ...
            (mockPrismaService.organization.findMany as jest.Mock).mockResolvedValue(expectedOrganizations);
    ...
    describe('findOne', () => {
        it('should return organization by id', async () => {
            ...
            (mockPrismaService.organization.findUnique as jest.Mock).mockResolvedValue(expectedOrganization);
