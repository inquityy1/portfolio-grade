...
describe('SubmissionsService', () => {
    ...
    describe('createSubmission', () => {
        ...
        it('should throw NotFoundException when form not found', async () => {
            ...
            await expect(service.createSubmission(orgId, formId, submissionData)).rejects.toThrow(NotFoundException);
            await expect(service.createSubmission(orgId, formId, submissionData)).rejects.toThrow('Form not found');
    ...
    describe('getSubmission', () => {
        ...
        it('should throw NotFoundException when submission not found', async () => {
            ...
            await expect(service.getSubmission(orgId, submissionId)).rejects.toThrow('Submission not found');
        ...
        it('should throw NotFoundException when submission does not exist', async () => {
            ...
            await expect(service.getSubmission(orgId, 'non-existent-submission')).rejects.toThrow(NotFoundException);
            await expect(service.getSubmission(orgId, 'non-existent-submission')).rejects.toThrow('Submission not found');
        });
    });
