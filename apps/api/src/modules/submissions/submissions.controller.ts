...
export class SubmissionsController {
    ...
    @ApiOperation({
        ...
        description: 'Allows public users to submit form data without authentication. This endpoint is accessible to anyone and is rate-limited by IP address to prevent abuse.'
    })
    @ApiParam({
        name: 'id',
    ...
    @ApiOperation({
        ...
        description: 'Retrieves all submissions for a specific form. Only accessible to users with Editor or higher role. Results are ordered by submission date descending.'
    })
    @ApiBearerAuth()
    @ApiParam({
        name: 'id',
    ...
    @ApiOperation({
        ...
        description: 'Retrieves detailed information about a specific submission by its ID. Accessible to users with Viewer or higher role.'
    })
    @ApiBearerAuth()
    @ApiParam({
        name: 'submissionId',
