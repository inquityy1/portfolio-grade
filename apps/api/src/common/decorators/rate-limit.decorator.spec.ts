...
describe('RateLimit Decorator', () => {
    ...
    describe('RateLimit decorator', () => {
        ...
        it('should handle different limit values', () => {
            ...
            expect(mockSetMetadata).toHaveBeenNthCalledWith(1, RATE_LIMIT_KEY, { perUser: { limit: 1, windowSec: 1 } });
            expect(mockSetMetadata).toHaveBeenNthCalledWith(2, RATE_LIMIT_KEY, { perUser: { limit: 1000, windowSec: 3600 } });
            expect(mockSetMetadata).toHaveBeenNthCalledWith(3, RATE_LIMIT_KEY, { perUser: { limit: 0, windowSec: 0 } });
        });
        ...
        it('should handle different window values', () => {
            ...
            expect(mockSetMetadata).toHaveBeenCalledTimes(3);
            expect(mockSetMetadata).toHaveBeenNthCalledWith(1, RATE_LIMIT_KEY, { perUser: { limit: 100, windowSec: 1 } });
            expect(mockSetMetadata).toHaveBeenNthCalledWith(2, RATE_LIMIT_KEY, { perUser: { limit: 100, windowSec: 60 } });
            expect(mockSetMetadata).toHaveBeenNthCalledWith(3, RATE_LIMIT_KEY, { perUser: { limit: 100, windowSec: 3600 } });
        });
    });
    ...
    describe('decorator usage patterns', () => {
        ...
        it('should work with inline configuration', () => {
            ...
            expect(mockSetMetadata).toHaveBeenCalledWith(RATE_LIMIT_KEY, { perUser: { limit: 50, windowSec: 30 } });
        });
    });
