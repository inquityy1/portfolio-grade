...
describe('Business Logic Integration Tests', () => {
  ...
  describe('Multi-tenant Isolation', () => {
    it('should ensure data isolation between organizations', async () => {
      ...
      expect(user2Forms).not.toContainEqual(expect.objectContaining({ id: form1Response.body.id }));
      ...
      expect(user1Forms).not.toContainEqual(expect.objectContaining({ id: form2Response.body.id }));
    });
  });
