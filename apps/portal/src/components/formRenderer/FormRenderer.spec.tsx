...
describe('FormRenderer', () => {
    ...
    it('should render input field correctly', () => {
        renderWithRouter(
            <FormRenderer fields={[inputField]} onSubmit={mockOnSubmit} />
        );
    ...
    it('should render textarea field correctly', () => {
        renderWithRouter(
            <FormRenderer fields={[textareaField]} onSubmit={mockOnSubmit} />
        );
    ...
    it('should render select field correctly', () => {
        renderWithRouter(
            <FormRenderer fields={[selectField]} onSubmit={mockOnSubmit} />
        );
    ...
    it('should render checkbox field correctly', () => {
        renderWithRouter(
            <FormRenderer fields={[checkboxField]} onSubmit={mockOnSubmit} />
        );
    ...
    it('should sort fields by order property', () => {
        ...
        renderWithRouter(
            <FormRenderer fields={unorderedFields} onSubmit={mockOnSubmit} />
        );
    ...
    it('should handle fields without order property', () => {
        ...
        renderWithRouter(
            <FormRenderer fields={[fieldWithoutOrder]} onSubmit={mockOnSubmit} />
        );
    ...
    it('should submit form with correct values', () => {
        renderWithRouter(
            <FormRenderer fields={[inputField, checkboxField]} onSubmit={mockOnSubmit} />
        );
    ...
    it('should handle empty fields array', () => {
        renderWithRouter(
            <FormRenderer fields={[]} onSubmit={mockOnSubmit} />
        );
    ...
    it('should use label as key when config.name is not available', () => {
        ...
        renderWithRouter(
            <FormRenderer fields={[fieldWithoutName]} onSubmit={mockOnSubmit} />
        );
    ...
    it('should handle select field with empty options', () => {
        ...
        renderWithRouter(
            <FormRenderer fields={[selectFieldEmpty]} onSubmit={mockOnSubmit} />
        );
    ...
    it('should handle textarea with default rows', () => {
        ...
        renderWithRouter(
            <FormRenderer fields={[textareaFieldDefault]} onSubmit={mockOnSubmit} />
        );
