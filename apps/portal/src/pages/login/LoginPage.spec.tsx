...
jest.mock('./LoginPage', () => {
    ...
    const MockLoginPage = function MockLoginPage() {
        ...
        if (token) {
            return <div data-testid="navigate" data-to="/" data-replace="true">Redirecting...</div>;
        }
        ...
        const handleSubmit = async (e: any) => {
            ...
            try {
                ...
                const me = await mockAxios.get('http://localhost:3000/api/auth/me', {
...
describe('LoginPage', () => {
    ...
    beforeEach(() => {
        ...
        mockUseLoginMutation.mockReturnValue([
            jest.fn().mockResolvedValue({ unwrap: () => Promise.resolve({ access_token: 'mock-token' }) }),
            { isLoading: false }
        ]);
    });
