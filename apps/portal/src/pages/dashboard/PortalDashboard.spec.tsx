...
describe('PortalDashboard', () => {
    ...
    it('should render the welcome message', () => {
        ...
        expect(screen.getByText('Welcome to the Portal. Use the navigation above to access different portal functions.')).toBeInTheDocument();
    });
    ...
    it('should render Forms description', () => {
        ...
        expect(screen.getByText((content, element) => {
            return element?.textContent === 'Forms - View and manage forms. Create new forms, edit existing ones, and preview form submissions.';
        })).toBeInTheDocument();
    });
    ...
    it('should render Posts description', () => {
        ...
        expect(screen.getByText((content, element) => {
            return element?.textContent === 'Posts - View and manage posts. Create new posts, edit existing ones, add comments, and filter by tags.';
        })).toBeInTheDocument();
    });
    ...
    it('should render Admin description', () => {
        ...
        expect(screen.getByText((content, element) => {
            return element?.textContent === 'Admin - Access admin functions (if you have admin privileges). Manage users, organizations, and system settings.';
        })).toBeInTheDocument();
    });
