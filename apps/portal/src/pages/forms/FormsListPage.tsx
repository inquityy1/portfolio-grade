...
import { Button, Card, CardHeader, CardTitle, CardContent, CardFooter, Container, LoadingContainer, ErrorContainer } from '@portfolio-grade/ui-kit';
    ...
    return (
        <Container>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                ...
                {canEdit && (
                    <Button onClick={goCreate}>Create new form</Button>
                )}
            </div>
