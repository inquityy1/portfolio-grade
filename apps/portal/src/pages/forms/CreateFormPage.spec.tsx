    ...
    const MockCreateFormPage = function MockCreateFormPage() {
        ...
        const handleSubmit = async (e: React.FormEvent) => {
            ...
            try {
                ...
                const { data } = await mockAxios.post('http://localhost:3000/api/forms', {
                    name: name.trim(),
                    schema: parsedSchema,
                }, {
                    headers: {
                ...
                mockNavigate('/forms', { replace: true, state: { flash: `Form "${data.name}" created successfully! ✅` } });
            } catch (e: any) {
        ...
        return (
            <div data-testid="container" style={{ maxWidth: '800px' }}>
                <div style={{ marginBottom: 24 }}>
                    ...
                    <p style={{ opacity: 0.7, margin: 0 }}>Create a new form with custom fields and validation.</p>
                </div>
...
describe('CreateFormPage', () => {
    ...
    it('should render page title and description', () => {
        ...
        expect(screen.getByText('Create a new form with custom fields and validation.')).toBeInTheDocument();
    });
