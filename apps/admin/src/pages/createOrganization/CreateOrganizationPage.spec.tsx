...
describe('CreateOrganizationPage', () => {
  ...
  it('should render the page with correct title and description', () => {
    ...
    expect(
      screen.getByText('Create a new organization to manage users, posts, and forms.'),
    ).toBeInTheDocument();
  });
  ...
  it('should show error for organization name too short', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText('Organization name must be at least 2 characters long'),
      ).toBeInTheDocument();
    });
  });
  ...
  it('should show error for organization name too long', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText('Organization name must be at most 100 characters long'),
      ).toBeInTheDocument();
    });
  });
